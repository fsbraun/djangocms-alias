...
class CreateAliasForm(BaseCreateAliasForm):
    ...
    def save(self):
        ...
        alias_content_manager = (
            AliasContent.objects.with_user(self.user) if is_versioning_enabled() else AliasContent.objects
        )
        alias_content = alias_content_manager.create(
            alias=alias,
